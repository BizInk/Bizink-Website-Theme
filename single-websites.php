...
?>
		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				while ( have_posts() ) {
					...
					//understrap_post_nav();?>
					<?php 
			//$background_color = get_field('website_select_background_color','option'); 
	...
	<div class="container">
		<div class="default-content">
			...
			<?php if($big_text_after_title){ ?><h3><?php echo $big_text_after_title; ?></h3><?php } ?>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="default-content">
					<h2><?php the_title(); ?></h2>
					<ul>
						<?php if(get_field('website_url')) { ?><li><b>Website URL :</b> <a href="<?php the_field('website_url'); ?>"><?php the_field('website_url'); ?></a></li><?php } ?>
						<?php if(get_field('location')) { ?><li><b>Location:</b> <?php the_field('location'); ?></li><?php } ?>
						<?php if(get_field('theme')) { ?><li><b>Theme:</b> <?php the_field('theme');  ?></li><?php } ?>
					</ul>
				</div>
			</div>
		</div>
...
<section class="cta-section text-center bg <?php echo $website2_select_background_color; ?>">
	...
	<div class="container">
		...
		<div class="default-content">
			...
			<?php if( $website2_description ) { echo $website2_description; } ?>
		</div>

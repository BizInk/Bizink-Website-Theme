					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="default-content">
								<h2><?php the_title(); ?></h2>
								<ul>
									<?php if (get_field('website_url')) { ?><li><b><?php _e('Website URL','bizink'); ?> :</b> <a href="<?php the_field('website_url'); ?>"><?php the_field('website_url'); ?></a></li><?php } ?>
									<?php if (get_field('location')) { ?><li><b><?php _e('Location','bizink'); ?>:</b> <?php the_field('location'); ?></li><?php } ?>
									<?php if (get_field('theme')) { ?><li><b><?php _e('Theme','bizink'); ?>:</b> <?php the_field('theme');  ?></li><?php } ?>
								</ul>
							</div>
						</div>
					</div>

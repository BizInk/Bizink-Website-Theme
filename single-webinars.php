							...
							<?php } ?>
								<?php  
									if( have_rows('website_content') ): 
										while( have_rows('website_content') ): the_row();
...
<section class="cta-section text-center bg <?php echo $webinar_select_background_color; ?>">
	...
	<div class="container">
		...
		<div class="default-content">
			<?php if( $webinar_title_text ){ ?><h2 class="<?php echo $webinar_title_color; ?>"><?php echo $webinar_title_text; ?></h2><?php } ?>
			<?php if($webinar_big_text_after_title){ ?><h3><?php echo $webinar_big_text_after_title; ?></h3><?php } ?>
			<?php if( $webinar_description ) { echo $webinar_description; } ?>
		</div>

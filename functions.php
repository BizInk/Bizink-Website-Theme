...
function create_type_hierarchical_taxonomy()
{
  ...
  // taxonomy register
  register_taxonomy('types', array('marketing_content'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'show_admin_column' => true,
...
function create_topic_hierarchical_taxonomy()
{
  ...
  // taxonomy register
  register_taxonomy('topics', array('marketing_content'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'show_admin_column' => true,
...
function create_region_hierarchical_taxonomy()
{
  ...
  // taxonomy register
  register_taxonomy('regions', array('marketing_content'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'show_admin_column' => true,
...
function custom_post_type_playbook()
{

...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.understrap = {}, global.Cookies));
	...
	*/
	...
	jQuery(document).ready(function () {
	  ...
	  jQuery('.cookie_banner .cookie_accept').click(function () {
	    jQuery('.cookie_banner').addClass('hidden');
	    Cookies.set('cookie_consent_analytics', 'true', {
	      expires: 30
	    });
	  ...
	  jQuery('.cookie_settings_save').click(function () {
	    ...
	    if (jQuery('#cookie_settings_form #analytics_cookies').is(":checked")) {
	      ...
	      Cookies.set('cookie_consent_analytics', 'false', {
	        expires: 30
	      });
	    }
	    Cookies.set('cookie_consent', 'true', {

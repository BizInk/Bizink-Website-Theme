/*!
  ...
  * Copyright 2013-2024 Bizink Online
...
(function (global, factory) {
	...
	*/
	...
	jQuery(document).ready(function () {
	  ...
	  console.log(api);
	  if (api.get('cookie_consent') == 'true') {
	    jQuery('.cookie_banner').addClass('hidden');
	  }
	  jQuery('.cookie_banner .cookie_accept').click(function () {
	    jQuery('.cookie_banner').addClass('hidden');
	    api.set('cookie_consent_analytics', 'true', {
	      expires: 30
	    });
	    api.set('cookie_consent', 'true', {
	      expires: 30
	    });
	  });
	  jQuery('.cookie_settings_save').click(function () {
	    if (jQuery('#cookie_settings_form #analytics_cookies').is(":checked")) {
	      ...
	      api.set('cookie_consent_analytics', 'false', {
	        expires: 30
	      });
	    }
	    api.set('cookie_consent', 'true', {
	    ...
	    jQuery('.cookie_banner').addClass('hidden');
	    api.remove('hubspotutk');
	    api.remove('tk_ai');
	    api.remove('__hstc');
	    api.remove('_reb2buid');
	    api.remove('hs_login_email');
	    api.remove('_ga');

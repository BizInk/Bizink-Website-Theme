<?php if ( have_rows( 'add_stats_section' ) ) : ?>
	<?php
	while ( have_rows( 'add_stats_section' ) ) :
		the_row();
		?>
		<?php
		...
		<section class="states-section text-center bg <?php echo $feature_background_color . ' ' . $white_text; ?>">
			...
			<div class="container">
				<div class="default-content">
					<?php
					if ( get_sub_field( 'top_title' ) ) {
						?>
						<h2 class="title"><?php echo get_sub_field( 'top_title' ); ?></h2><?php } ?>
					<?php
									...
									<div class="inner-wrap">
										...
										if ( get_sub_field( 'show_symbol_on_left' )[0] == 'Yes' ) {
											if ( $number ) {
												...
												if ( $symbol ) {
													?>
													<span><?php echo $symbol; ?></span><?php } ?><?php echo $number; ?></h2>
												<?php
											}
										} elseif ( $number ) {
											?>
												<h2><?php echo $number; ?>
																...
																if ( $symbol ) {
																	?>
													<span><?php echo $symbol; ?></span><?php } ?></h2>
												<?php

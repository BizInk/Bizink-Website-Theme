						...
						<?php if (have_rows('pricing_data')) : ?>
							<div class="table-main table-responsive">
								...
								?>
									...
									<?php
									$text_right_side = get_sub_field('need_floated_offer_text_on_right_side_of_table')[0] ?: 'No';

									if ($text_right_side == 'Yes') { ?>
									...
									$pricing_note_text_after_table = get_sub_field('pricing_note_text_after_table') ?: false;
									if ($pricing_note_text_after_table) {
									?>
										<div class="note">
											<p><?php echo $pricing_note_text_after_table; ?></p>
										</div>
								<?php
									}
								endwhile;

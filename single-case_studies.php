		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				while ( have_posts() ) {
					...
					//understrap_post_nav();?>
<section class="cta-section case-study-banner text-center bg" style="background-image: url(<?php if(get_field('featured_image')): echo get_field('featured_image'); endif; ?>); background-repeat: no-repeat; background-size: cover;">
	<div class="container">
